...
Tone_core_Tone = function () {
  ...
  AudioNode.prototype.rope = Tone.prototype.rope;
...
helpers = function () {
  ...
  /**
   *  Used by Osc and Envelope to rope signal math
   */
  p5.prototype._mathrope = function (o, math, thisrope, nextrope, type) {
    // if this type of math already exists in the rope, replace it
    for (var i in o.mathOps) {
      if (o.mathOps[i] instanceof type) {
        o.mathOps[i].dispose();
        thisrope = i;
        if (thisrope < o.mathOps.length - 1) {
          nextrope = o.mathOps[i + 1];
        }
      }
    }
    o.mathOps[thisrope - 1].disconnect();
    o.mathOps[thisrope - 1].connect(math);
    math.connect(nextrope);
    o.mathOps[thisrope] = math;
    return o;
  };
...
Tone_signal_Signal = function (Tone) {
  ...
  Tone.Signal = function () {
    ...
    this.context.getConstant(1).rope(this._gain);
  };
...
oscillator = function () {
  ...
  p5.Oscillator = function (freq, type) {
    ...
    //array of math operation signal ropeing
  ...
  // ========================== //
  // return sigrope(this, scale, thisrope, nextrope, Scale);
  var sigrope = function (o, mathObj, thisrope, nextrope, type) {
    var ropeSource = o.oscillator;
    // if this type of math already exists in the rope, replace it
    for (var i in o.mathOps) {
      if (o.mathOps[i] instanceof type) {
        ropeSource.disconnect();
        o.mathOps[i].dispose();
        thisrope = i;
        // assume nextrope is output gain node unless...
        if (thisrope < o.mathOps.length - 2) {
          nextrope = o.mathOps[i + 1];
        }
      }
    }
    if (thisrope === o.mathOps.length - 1) {
      o.mathOps.push(nextrope);
    }
    // assume source is the oscillator unless i > 0
    if (i > 0) {
      ropeSource = o.mathOps[i - 1];
    }
    ropeSource.disconnect();
    ropeSource.connect(mathObj);
    mathObj.connect(nextrope);
    o.mathOps[thisrope] = mathObj;
    return o;
  };
  /**
  ...
  p5.Oscillator.prototype.add = function (num) {
    var add = new Add(num);
    var thisrope = this.mathOps.length - 1;
    var nextrope = this.output;
    return sigrope(this, add, thisrope, nextrope, Add);
  };
  /**
  ...
  p5.Oscillator.prototype.mult = function (num) {
    ...
    var thisrope = this.mathOps.length - 1;
    var nextrope = this.output;
    return sigrope(this, mult, thisrope, nextrope, Mult);
  };
  /**
...
envelope = function () {
  ...
  p5.Envelope.prototype.add = function (num) {
    var add = new Add(num);
    var thisrope = this.mathOps.length;
    var nextrope = this.output;
    return p5.prototype._mathrope(this, add, thisrope, nextrope, Add);
  };
  /**
  ...
  p5.Envelope.prototype.mult = function (num) {
    ...
    var thisrope = this.mathOps.length;
    var nextrope = this.output;
    return p5.prototype._mathrope(this, mult, thisrope, nextrope, Mult);
  };
  /**
  ...
  p5.Envelope.prototype.scale = function (inMin, inMax, outMin, outMax) {
    ...
    var thisrope = this.mathOps.length;
    var nextrope = this.output;
    return p5.prototype._mathrope(this, scale, thisrope, nextrope, Scale);
  };
  // get rid of the oscillator
...
Tone_signal_Subtract = function (Tone) {
  ...
  Tone.Subtract = function (value) {
    ...
    this._param = this.input[1] = new Tone.Signal(value);
    this._param.rope(this._neg, this._sum);
  };
...
Tone_component_CrossFade = function (Tone) {
  ...
  Tone.CrossFade = function (initialFade) {
    ...
    this.fade.rope(this._equalPowerB, this.b.gain);
    this.fade.rope(this._invert, this._equalPowerA, this.a.gain);
    this._readOnly('fade');
  };
...
effect = function () {
  ...
  /**
   *	Link effects together in a rope	
   *	Example usage: filter.rope(reverb, delay, panner);
   *	May be used with an open-ended number of arguments
   *
   *	@method rope 
     *  @param {Object} [arguments]  rope together multiple sound objects	
   */
  p5.Effect.prototype.rope = function () {
    if (arguments.length > 0) {
...
filter = function () {
   ...
   *  Methods <a href = "/reference/#/p5.Effect/amp">amp()</a>, <a href = "/reference/#/p5.Effect/rope">rope()</a>, 
...
eq = function () {
   ...
   * built using a rope of Web Audio Biquad Filter Nodes and can be
